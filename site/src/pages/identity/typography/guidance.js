...
const Guidance = () => {
  return (
    <>
      ...
      >
        <SubContent SubContent="For KhulnaSoft, we utilized the major third ratio to generate at a type scale that we could work with." />
      ...
      <div className="pt-[2.5rem]">
        <SubText
          ...
          length="2"
        >
          <SubContent SubContent="KhulnaSoft has successfully been able to implement a font pairing of Qanelas Soft for all heading and subheading text and Open Sans for all body, paragraph, and content text needs." />
        </SubText>
      </div>
